...
- `content/platforms/x.md` — the x playbook: hard format constraints, structure, avoid-list,
...
4. Read `content/platforms/x.md` (the playbook). Produce the variant per the GROUNDING block,
