...
- `content/platforms/linkedin.md` — the linkedin playbook: hard format constraints, structure, avoid-list,
...
4. Read `content/platforms/linkedin.md` (the playbook). Produce the variant per the GROUNDING block,
